...
for i in ${!GPU_IDS[@]}; do
  ...
  VQVAE_CKPT="../formal_experiment/mitdb_two_channels/dsp_flow_mixed_K${NUM_CODES}/vqvae_save_path"
  PRETRAIN_CKPT="../formal_experiment/mitdb_two_channels/dsp_flow_mixed_K${NUM_CODES}/no_context_pretrain_ckpt"
  FINETUNE_CKPT="../formal_experiment/mitdb_two_channels/dsp_flow_mixed_K${NUM_CODES}/impute_finetune_ckpt_lr${LR}"
...
#    --gpu_id 0
  ...
  python dsp_flow.py \
    --what_to_do "principle_posterior_impute_sample_show_diversity" \
    \
    --num_codes ${NUM_CODES} \
    --seq_len ${LEN_WHOLE} \
    --data_type ${DATA_TYPE} \
...
#OUTDIR="../nn_eval/mitdb_two_channels/dsp_flow_mixed_K${NUM_CODES}"
#
