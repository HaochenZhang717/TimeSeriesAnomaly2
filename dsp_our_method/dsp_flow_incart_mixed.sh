...
#  FINETUNE_CKPT="../formal_experiment/incart_6_channels/dsp_flow_mixed_K${NUM_CODES}/prediction_finetune_ckpt_lr${LR}"
...
#  python dsp_flow.py \
#    --what_to_do "prediction_finetune" \
#    --num_codes ${NUM_CODES} \
#    --seq_len ${LEN_WHOLE} \
#    --data_type ${DATA_TYPE} \
#    --feature_size ${FEAT_SIZE} \
...
#    --patience 500 \
#    --wandb_project ${WANDB_PROJECT} \
#    --wandb_run "prediction_finetune_mixed_lr${LR}_K${NUM_CODES}" \
#    --ckpt_dir ${FINETUNE_CKPT} \
#    --pretrained_ckpt ${PRETRAIN_CKPT} \
#    --vqvae_ckpt "${VQVAE_CKPT}/vqvae.pt" \
#    --generated_path "none" \
...
#  python dsp_flow.py \
#    --what_to_do "posterior_predict_sample" \
#    \
#    --num_codes ${NUM_CODES} \
#    --seq_len ${LEN_WHOLE} \
#    --data_type ${DATA_TYPE} \
...
#  python dsp_flow.py \
#    --what_to_do "posterior_predict_sample_non_downstream" \
#    \
#    --num_codes ${NUM_CODES} \
#    --seq_len ${LEN_WHOLE} \
#    --data_type ${DATA_TYPE} \
