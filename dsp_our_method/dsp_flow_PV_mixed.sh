...
for i in ${!GPU_IDS[@]}; do
  ...
  VQVAE_CKPT="../formal_experiment/PV/dsp_flow_mixed_K${NUM_CODES}/vqvae_save_path"
  PRETRAIN_CKPT="../formal_experiment/PV/dsp_flow_mixed_K${NUM_CODES}/no_context_pretrain_ckpt"
  FINETUNE_CKPT="../formal_experiment/PV/dsp_flow_mixed_K${NUM_CODES}/impute_finetune_ckpt_lr${LR}"
