...
DATA_TYPE="ecg"
WANDB_PROJECT="dsp_flow_svdb_no_context_anomaly"
...
PRETRAIN_INDICES_PATHS='["./dataset_utils/ECG_datasets/indices_svdb/slide_windows_859npz/V_segments_train.jsonl"]'
...
(
  ...
  VQVAE_CKPT="../formal_experiment/svdb_two_channels/dsp_flow_no_context_anomaly_K${NUM_CODES}/vqvae_save_path"
  PRETRAIN_CKPT="../formal_experiment/svdb_two_channels/dsp_flow_no_context_anomaly_K${NUM_CODES}/no_context_pretrain_ckpt"
  FINETUNE_CKPT="../formal_experiment/svdb_two_channels/dsp_flow_no_context_anomaly_K${NUM_CODES}/impute_finetune_ckpt_lr${LR}"
