...
DATA_TYPE="ecg"
WANDB_PROJECT="dsp_flow_svdb_one_channel"

VQVAE_CKPT="/root/tianyi/formal_experiment/svdb_one_channel/dsp_flow_new/vqvae_save_path"
PRETRAIN_CKPT="/root/tianyi/formal_experiment/svdb_one_channel/dsp_flow_new/no_context_pretrain_ckpt"
FINETUNE_CKPT="/root/tianyi/formal_experiment/svdb_one_channel/dsp_flow_new/impute_finetune_ckpt_lr${LR}"
