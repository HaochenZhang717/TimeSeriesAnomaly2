...
(
  ...
  VQVAE_CKPT="/root/tianyi/formal_experiment/svdb_two_channels/dsp_flow_K${NUM_CODES}/vqvae_save_path"
  PRETRAIN_CKPT="/root/tianyi/formal_experiment/svdb_two_channels/dsp_flow_K${NUM_CODES}/no_context_pretrain_ckpt"
  FINETUNE_CKPT="/root/tianyi/formal_experiment/svdb_two_channels/dsp_flow_K${NUM_CODES}/impute_finetune_ckpt_lr${LR}"
