...
DATA_TYPE="ecg"
WANDB_PROJECT="GenIAS_svdb_two_channels"

FINETUNE_CKPT="../formal_experiment/svdb_two_channels/GENIAS/ckpt_lr${LR}"
...
#python genias_pipeline.py \
#  --what_to_do "impute_normal_sample" \
#  \
#  --seq_len ${LEN_WHOLE} \
#  --data_type ${DATA_TYPE} \
#  --feature_size ${FEAT_SIZE} \
...
OUTDIR="../nn_eval/svdb_two_channels/GENIAS"
