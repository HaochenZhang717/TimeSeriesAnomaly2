...
VQVAE_CKPT="none"
PRETRAIN_CKPT="/root/tianyi/formal_experiment/qtdb/dsp_flow/no_context_no_code_pretrain_ckpt"
FINETUNE_CKPT="/root/tianyi/formal_experiment/qtdb/dsp_flow/no_code_impute_finetune_ckpt_lr${LR}"
...
FINETUNE_TEST_INDICES_PATHS='["./dataset_utils/ECG_datasets/indices_qtdb/slide_windows_sel233npz/V_train.jsonl"]'
