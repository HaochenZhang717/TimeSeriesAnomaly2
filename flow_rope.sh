...
python FlowFinetuneEvaluateAnomaly.py \
  ...
  --batch_size 64 \
  \
  --model_ckpt "../TSA-ckpts/flow_normal_finetune_ckpt_mitdb106_rope_v2_mixed_data/2025-12-01-16:37:14/ckpt.pth" \
  --gpu_id 3 \
  \
  --need_to_generate 1 \
  --generated_path "../samples_path/flow/mitdb106v-finetuned-rope-v2-mixed_data" \
