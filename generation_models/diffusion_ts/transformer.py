...
class EncoderBlock(nn.Module):
    ...
    def forward(self, x, timestep, mask, label_emb=None):
...
class Encoder(nn.Module):
    ...
    def forward(self, input, t, padding_masks, label_emb=None):
        x = input
...
class DecoderBlock(nn.Module):
    ...
    def forward(self, x, encoder_output, timestep, mask, label_emb=None):
...
class Transformer(nn.Module):
    ...
    def forward(self, input, t, padding_masks, return_res=False):
        emb = self.emb(input)
