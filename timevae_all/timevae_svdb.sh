...
DATA_TYPE="ecg"
WANDB_PROJECT="TimeVAE_svdb_two_channels"

FINETUNE_CKPT="../formal_experiment/svdb_two_channels/TimeVAE/no_code_impute_from_scratch_ckpt_lr${LR}"
...
#OUTDIR="../nn_eval/svdb_two_channels/TimeVAE"
#
#
