...
PRETRAIN_INDICES_PATHS='["./dataset_utils/ECG_datasets/indices_qtdb/slide_windows_sel233npz/mixed.jsonl"]'
...
for i in ${!GPU_IDS[@]}; do
  ...
  VQVAE_CKPT="../formal_experiment/qtdb_two_channels/dsp_flow_mixed_K${NUM_CODES}_no_pretrain/vqvae_save_path"
  PRETRAIN_CKPT="../formal_experiment/qtdb_two_channels/dsp_flow_mixed_K${NUM_CODES}_no_pretrain/no_context_pretrain_ckpt"
  FINETUNE_CKPT="../formal_experiment/qtdb_two_channels/dsp_flow_mixed_K${NUM_CODES}_no_pretrain/impute_finetune_ckpt_lr${LR}"

  echo "Launching NUM_CODES=${NUM_CODES} on GPU ${GPU}"

  python mini_runnable_vqvae.py \
    --wandb_project ${WANDB_PROJECT} \
    --wandb_run "VQVAE-mixed_K${NUM_CODES}" \
...
OUTDIR="../nn_eval/qtdb_two_channels/dsp_flow_mixed_K${NUM_CODES}_no_pretrain"
