...
for i in ${!GPU_IDS[@]}; do
  ...
  VQVAE_CKPT="../formal_experiment/mitdb_two_channels/dsp_flow_mixed_K${NUM_CODES}_no_pretrain/vqvae_save_path"
  PRETRAIN_CKPT="../formal_experiment/mitdb_two_channels/dsp_flow_mixed_K${NUM_CODES}_no_pretrain/no_context_pretrain_ckpt"
  FINETUNE_CKPT="../formal_experiment/mitdb_two_channels/dsp_flow_mixed_K${NUM_CODES}_no_pretrain/impute_finetune_ckpt_lr${LR}"
...
OUTDIR="../nn_eval/mitdb_two_channels/dsp_flow_mixed_K${NUM_CODES}_no_pretrain"
