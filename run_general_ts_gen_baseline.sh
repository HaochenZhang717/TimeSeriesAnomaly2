...
CUDA_VISIBLE_DEVICES=0 bash timevae_all/cgats_qt.sh
CUDA_VISIBLE_DEVICES=0 bash timevae_all/cgats_svdb.sh

CUDA_VISIBLE_DEVICES=3 bash timevae_all/timevae_mitdb.sh
CUDA_VISIBLE_DEVICES=0 bash timevae_all/timevae_qt.sh
CUDA_VISIBLE_DEVICES=3 bash timevae_all/timevae_svdb.sh
