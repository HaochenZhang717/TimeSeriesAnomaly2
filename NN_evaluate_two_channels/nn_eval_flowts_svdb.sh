...
FINETUNE_CKPT="/root/tianyi/formal_experiment/svdb_two_channels/flowts/no_code_impute_from_scratch_ckpt_lr1e-4"
OUTDIR="/root/tianyi/nn_eval/svdb_two_channels/flowts"
