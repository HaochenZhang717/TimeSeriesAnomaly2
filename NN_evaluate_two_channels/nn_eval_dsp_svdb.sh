...
FINETUNE_CKPT="../formal_experiment/svdb_two_channels/dsp_flow_mixed_K${NUM_CODES}/impute_finetune_ckpt_lr1e-4"
OUTDIR="../nn_eval/svdb_two_channels/dsp_flow_mixed_K${NUM_CODES}"
