...
#CUDA_VISIBLE_DEVICES=1 bash nn_eval_diffts_mitdb.sh
#CUDA_VISIBLE_DEVICES=2 bash nn_eval_diffts_mitdb.sh
#
#CUDA_VISIBLE_DEVICES=0 bash nn_eval_flowts_mitdb.sh
#CUDA_VISIBLE_DEVICES=1 bash nn_eval_flowts_mitdb.sh
#CUDA_VISIBLE_DEVICES=2 bash nn_eval_flowts_mitdb.sh
