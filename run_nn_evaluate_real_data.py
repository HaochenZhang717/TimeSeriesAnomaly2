...
def main():
    ...
    real_data, real_labels = extract_data_and_labels(real_set, device, args.one_channel)

    fake_set = ImputationECGDataset(
        raw_data_paths=args.raw_data_paths,
    ...
    gen_data, gen_labels = extract_data_and_labels(fake_set, device, args.one_channel)
