...
VQVAE_CKPT="none"
PRETRAIN_CKPT="/root/tianyi/formal_experiment/svdb_one_channel/dsp_flow_no_code/no_context_pretrain_ckpt"
FINETUNE_CKPT="/root/tianyi/formal_experiment/svdb_one_channel/dsp_flow_no_code/impute_finetune_ckpt_lr${LR}"
...
OUTDIR="../nn_eval/svdb_two_channels/dspflow_no_code"
