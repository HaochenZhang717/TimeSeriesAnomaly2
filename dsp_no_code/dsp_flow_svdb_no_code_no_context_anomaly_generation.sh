...
VQVAE_CKPT="none"
PRETRAIN_CKPT="../formal_experiment/svdb_two_channels/dsp_flow_no_code_no_context_anomaly/no_context_no_code_pretrain_ckpt"
FINETUNE_CKPT="../formal_experiment/svdb_two_channels/dsp_flow_nodsp_flow_no_code_no_context_anomaly_code/no_code_impute_finetune_ckpt_lr${LR}"
