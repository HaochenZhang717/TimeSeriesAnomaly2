...
VQVAE_CKPT="none"
PRETRAIN_CKPT="../formal_experiment/incart_6_channels/dsp_flow_no_code/no_context_no_code_pretrain_ckpt"
FINETUNE_CKPT="../formal_experiment/incart_6_channels/dsp_flow_no_code/no_code_impute_finetune_ckpt_lr${LR}"
#FINETUNE_CKPT="../formal_experiment/incart_6_channels/dsp_flow_no_code/no_code_prediction_finetune_ckpt_lr${LR}"
...
PREDICTION_TRAIN_INDICES_PATHS='["./dataset_utils/ECG_datasets/indices_incart/slide_windows_I30npz/V_segments_train.jsonl"]'
PREDICTION_TEST_INDICES_PATHS='["./dataset_utils/ECG_datasets/indices_incart/slide_windows_I30npz/V_segments_test.jsonl"]'
...
#python dsp_flow.py \
#  --what_to_do "no_code_prediction_finetune" \
#  \
#  --seq_len ${LEN_WHOLE} \
#  --data_type ${DATA_TYPE} \
#  --feature_size ${FEAT_SIZE} \
...
#  --raw_data_paths_test ${TEST_DATA_PATHS} \
#  --event_labels_paths_train ${EVENT_LABELS_PATHS} \
#  --indices_paths_train ${PREDICTION_TRAIN_INDICES_PATHS} \
#  --indices_paths_test ${PREDICTION_TEST_INDICES_PATHS} \
#  --indices_paths_anomaly_for_sample "[]" \
#  --min_infill_length ${MIN_LEN_ANOMALY} \
#  --max_infill_length ${MAX_LEN_ANOMALY} \
#  \
...
#  \
#  --wandb_project ${WANDB_PROJECT} \
#  --wandb_run "no_code_prediction_finetune_lr${LR}" \
#  \
#  --ckpt_dir ${FINETUNE_CKPT} \
#  --pretrained_ckpt ${PRETRAIN_CKPT} \
#  --vqvae_ckpt "${VQVAE_CKPT}/vqvae.pt" \
...
#python dsp_flow.py \
#  --what_to_do "no_code_predict_sample" \
#  \
#  --seq_len ${LEN_WHOLE} \
#  --data_type ${DATA_TYPE} \
#  --feature_size ${FEAT_SIZE} \
...
#python dsp_flow.py \
#  --what_to_do "no_code_predict_sample_non_downstream" \
#  \
#  --seq_len ${LEN_WHOLE} \
#  --data_type ${DATA_TYPE} \
#  --feature_size ${FEAT_SIZE} \
...
#  --raw_data_paths_test ${TEST_DATA_PATHS} \
#  --event_labels_paths_train ${EVENT_LABELS_PATHS} \
#  --indices_paths_train ${PREDICTION_TEST_INDICES_PATHS} \
#  --indices_paths_test "[]" \
#  --indices_paths_anomaly_for_sample ${ANOMALY_INDICES_FOR_SAMPLE} \
#  --min_infill_length ${MIN_LEN_ANOMALY} \
#  --max_infill_length ${MAX_LEN_ANOMALY} \
