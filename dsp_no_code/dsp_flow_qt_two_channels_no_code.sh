...
VQVAE_CKPT="none"
PRETRAIN_CKPT="/root/tianyi/formal_experiment/qtdb_two_channels/dsp_flow/no_context_no_code_pretrain_ckpt"
FINETUNE_CKPT="/root/tianyi/formal_experiment/qtdb_two_channels/dsp_flow/no_code_impute_finetune_ckpt_lr${LR}"
