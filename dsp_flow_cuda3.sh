...
VQVAE_TRAIN_NORMAL_INDICES_PATHS='["./dataset_utils/ERCOT_datasets/indices/coast_normal_200.jsonl", "./dataset_utils/ERCOT_datasets/indices/east_normal_200.jsonl", "./dataset_utils/ERCOT_datasets/indices/fwest_normal_200.jsonl", "./dataset_utils/ERCOT_datasets/indices/ncent_normal_200.jsonl"]'
VQVAE_TRAIN_ANOMALY_INDICES_PATHS='["./dataset_utils/ERCOT_datasets/indices/anomaly_segments_coast.jsonl", "./dataset_utils/ERCOT_datasets/indices/anomaly_segments_east.jsonl", "./dataset_utils/ERCOT_datasets/indices/anomaly_segments_fwest.jsonl", "./dataset_utils/ERCOT_datasets/indices/anomaly_segments_ncent.jsonl"]'
CODE_DIM=8
CODE_LEN=4
NUM_CODES=500
...
python mini_runnable_vqvae.py \
  ...
  \
  --normal_data_paths "${DATA_PATHS}" \
  --normal_indices_paths "${VQVAE_TRAIN_NORMAL_INDICES_PATHS}"\
  --anoamly_data_paths "${DATA_PATHS}" \
  --anomaly_indices_paths "${VQVAE_TRAIN_ANOMALY_INDICES_PATHS}"\
  \
  --data_type ${DATA_TYPE} \
  --gpu_id ${GPU_ID} \
  --save_dir ${VQVAE_CKPT} \
